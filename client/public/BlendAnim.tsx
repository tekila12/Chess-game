...
Command: npx gltfjsx@6.1.4 blendAnim.glb --types
*/
...
/*
Auto-generated by: https://github.com/pmndrs/gltfjsx
Command: npx gltfjsx@6.1.4 chess2.glb --types
*/
...
type ActionName = 'Sketchfab_model' | 'Collada visual scene group' | 'blackpieces_mesh' | 'defaultMaterial.001' | 'defaultMaterial.002' | 'defaultMaterial.003' | 'defaultMaterial.013' | 'defaultMaterial.015' | 'defaultMaterial.016' | 'defaultMaterial.017' | 'defaultMaterial.018' | 'defaultMaterial.019' | 'chessboard_mesh' | 'defaultMaterial.012' | 'whitepieces_mesh' | 'defaultMaterial.004' | 'defaultMaterial.005' | 'defaultMaterial.006' | 'defaultMaterial.007' | 'defaultMaterial.008' | 'defaultMaterial.011' | 'defaultMaterial.034' | 'defaultMaterial.038' | 'defaultMaterial.040' | 'defaultMaterial.041' | 'defaultMaterial.043' | 'defaultMaterial.044' | 'defaultMaterial.045' | 'defaultMaterial.046' | 'defaultMaterial.048' | 'defaultMaterial.049' | 'defaultMaterial.050' | 'defaultMaterial.051' | 'defaultMaterial.010' | 'defaultMaterial.033' | 'defaultMaterial.047' | 'defaultMaterial.052' | 'defaultMaterial.009' | 'defaultMaterial.020' | 'defaultMaterial.021' | 'QueenAnimation'
type GLTFActions = Record<ActionName, THREE.AnimationAction>

export default function ChessBoard(props: JSX.IntrinsicElements['group']) {
  const group = useRef<THREE.Group>()
  const { nodes, materials, animations } = useGLTF('/chess2.glb') as GLTFResult
  const { actions } = useAnimations(animations, group);

console.log(useAnimations)
  useEffect(() => {
    const timer = setTimeout(() => {
      if (actions.QueenAnimation) {
        actions.QueenAnimation.play()
      }
      
    }, 3000)
    return () => clearTimeout(timer)
  }, [actions.QueenAnimation])
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
